...
(
 ...
 `fine_week_5` int default -1,
 `fine_week_6` int default -1,
 `fine_week_7` int default -1,
 `fine_week_8` int default -1,
 `fine_week_9` int default -1,
 `fine_week_10` int default -1,
 `fine_week_11` int default -1,
 `fine_week_12` int default -1,
 `fine_week_13` int default -1,
 `fine_week_14` int default -1,
 `fine_week_15` int default -1,
 `fine_week_16` int default -1,
 `fine_week_17` int default -1,
 `fine_week_18` int default -1,
 `fine_week_19` int default -1,
 PRIMARY KEY  (`autoid`),
 unique key (`member_name`)
 )
CREATETABLE
